...
static void on_login_clicked(GtkButton *button, gpointer user_data)
{
    ...
    // todo
    /*
    Avoir une variable (globale) de session pour mon utilisateur. Celle ci
    contient l'id_user de l'utilisateur qui vient de se connecter.
    Faire une requete a la base de donnee pour recuperer l'utilisateur
    session_id_user = resultat requete select id_user from users where username = username ou username est que dans cette fonction
