...
static void on_emoji_button_clicked(GtkButton *button, gpointer user_data) {
    (void)button;
    GtkWidget *emoji_popover = GTK_WIDGET(user_data);
...
static void activate(GtkApplication* app, gpointer user_data) {
    ...
    GtkWidget *scrolled_window, *channels_box, *connect_button, *user_label;
    ...
    gtk_widget_set_size_request(chat_display, 980, -1);
    ...
    size_t num_widgets = sizeof(widgets_to_style) / sizeof(GtkWidget*);
